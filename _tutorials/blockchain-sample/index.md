...
> **DISCLAIMER**: this is a **prototype** that is currently under development by the IBM Blockchain team. As a result, it may dramatically change, have major bugs, completly fail to work, or disappear altogether. There is **no** officially provided support for this project; any bugs that you report may go unfixed for a longer period of time than you're comfortable with. If you're happy with all of that, then please carry on reading! As we work on the project, we're extremely interested in your feedback about how we could make it better, so please do let us know by raising issues on this GitHub repository!

:warning: :construction: :construction_worker:

Hello! This GitHub repository can be used for building a sample blockchain application using the IBM Blockchain Platform. These instructions include everything you need for developing smart contracts, exposing them via RESTful APIs, building end user applications, and automatically deploying everything to the IBM Cloud, including any future changes you make.
